// Generated by Wrangler by running `wrangler types` (hash: 15f5cf84034eec79056ed3778493aea3)
// Runtime types generated with workerd@1.20250410.0 2025-04-01 nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
	interface Env {
		USERNAME: "caise";
		HOSTNAME: "quorra.deathbyknowledge.com";
		SECRET_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "USERNAME" | "HOSTNAME" | "SECRET_KEY" | "QUORRA_DISCORD_TOKEN" | "DISCORD_USER_ID" | "SEARCH_KEY">> {}
}
