// Generated by Wrangler by running `wrangler types` (hash: edeb6b5646a69bd9c662d50ed7ab9ece)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SECRET_KEY" | "NOUS_KEY" | "OPENAI_KEY" | "DEEPSEEK_KEY" | "QUORRA_DISCORD_TOKEN" | "DISCORD_USER_ID">> {}
}
declare module "*.md" {
	const value: string;
