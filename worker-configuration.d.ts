// Generated by Wrangler by running `wrangler types` (hash: ac962a52117d507be83d893a56582ad7)
// Runtime types generated with workerd@1.20250410.0 2025-04-01 nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
	interface Env {
		...
		OPENAI_KEY: string;
		DEEPSEEK_KEY: string;
		QUORRA_DISCORD_TOKEN: string;
		DISCORD_USER_ID: string;
		SEARCH_KEY: string;
		CLOUDFLARE_ACCOUNT_ID: string;
		CF_TOKEN: string;
		Quorra: DurableObjectNamespace<import("./api/index").Quorra>;
		FILE_SYSTEM: R2Bucket;
		BUS: Queue;
		EMAIL: SendEmail;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SECRET_KEY" | "NOUS_KEY" | "OPENAI_KEY" | "DEEPSEEK_KEY" | "QUORRA_DISCORD_TOKEN" | "DISCORD_USER_ID" | "SEARCH_KEY" | "CLOUDFLARE_ACCOUNT_ID" | "CF_TOKEN">> {}
}
